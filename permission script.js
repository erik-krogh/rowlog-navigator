...
var observer = new MutationObserver(function(mutations) {
    ...
    const table = $(".modal-container .modal-content .modal-body table.table-borderless");
    // the table header (<thread>) needs to have 3 elements: "Navn", "Antal", "".
    const children = table.find("thead").children().toArray().map(e => $(e).text().trim());
    if (children.length !== 3 || children[0] !== "Navn" || children[1] !== "Antal" || children[2] !== "") {
        return;
    }
